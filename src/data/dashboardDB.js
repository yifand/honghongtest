...
export const DB = Vue.observable({
  users: [
    { id: 1, enterprise: 'SenseTime', account: 'sensetime@gs.com', password: 'Abc12345', code: 'ZNJS001', phone: '+86-755-86189999', email: 'contact@sensetime.com', instance: 'SRV-SZX-001', poolName: 'Pool-ST-01', poolNo: 'RP-20260501-001', created: '2026-05-01', updated: '2026-05-10' },
    { id: 2, enterprise: 'DJI', account: 'dji@gs.com', password: 'Xyz67890', code: 'CH003', phone: '+86-755-26656818', email: 'dev@dji.com', instance: 'SRV-SZX-002', poolName: 'Pool-DJI-01', poolNo: 'RP-20260502-001', created: '2026-05-03', updated: '2026-05-12' },
    { id: 3, enterprise: 'XAG', account: 'xag@gs.com', password: 'Pwd11111', code: 'CH005', phone: '+86-20-83936333', email: 'api@xag.cn', instance: 'SRV-CAN-001', poolName: 'Pool-XAG-01', poolNo: 'RP-20260503-001', created: '2026-05-05', updated: '2026-05-15' },
    { id: 4, enterprise: 'AutoX', account: 'autox@gs.com', password: 'Qwe22222', code: 'ZNJS003', phone: '+86-21-61133333', email: 'rd@autox.ai', instance: 'SRV-SH-001', poolName: 'Pool-AX-01', poolNo: 'RP-20260504-001', created: '2026-05-08', updated: '2026-05-18' },
    { id: 5, enterprise: 'DeepRoute', account: 'deeproute@gs.com', password: 'Asd33333', code: 'ZNJS005', phone: '+86-755-86368888', email: 'info@deeproute.ai', instance: 'SRV-SZX-003', poolName: 'Pool-DR-01', poolNo: 'RP-20260505-001', created: '2026-05-10', updated: '2026-05-20' }
  ],
  orders: [
  ...
  accounts: [
    { id: 1, name: 'ntrip_st001', password: 'aB3xK9mQ', enterprise: 'SenseTime', svcType: 'NRTK', mode: 'Ntrip', spec: 'year', stack: 3, device: 'GNSS-Receiver-V3', activated: 'activated', created: '2026-05-02', expires: '2027-05-02', partner: 'ZNJS', activationTime: '2026-05-02' },
    { id: 2, name: 'ntrip_st002', password: 'pQ7rT2wN', enterprise: 'SenseTime', svcType: 'NRTK', mode: 'Ntrip', spec: 'year', stack: 3, device: 'GNSS-Receiver-V3', activated: 'activated', created: '2026-05-02', expires: '2027-05-02', partner: 'ZNJS', activationTime: '2026-05-03' },
    { id: 3, name: 'DID_dji001', password: 'xM4kL8jH', enterprise: 'DJI', svcType: 'PPP-RTK', mode: 'SDK', spec: 'month', stack: 6, device: 'Drone-M300-RTK', activated: 'inactive', created: '2026-05-06', expires: '2026-11-06', partner: 'CH', activationTime: '' },
    { id: 4, name: 'DID_dji002', password: 'cV2nB5fG', enterprise: 'DJI', svcType: 'PPP-RTK', mode: 'SDK', spec: 'month', stack: 6, device: 'Drone-M300-RTK', activated: 'activated', created: '2026-05-06', expires: '2026-11-06', partner: 'CH', activationTime: '2026-05-07' },
    { id: 5, name: 'ntrip_xag001', password: 'zA9sD4eR', enterprise: 'XAG', svcType: 'NRTK', mode: 'Ntrip', spec: 'day', stack: 7, device: 'Agri-Drone-P100', activated: 'activated', created: '2026-05-07', expires: '2026-05-14', partner: 'CH', activationTime: '2026-05-07' },
    { id: 6, name: 'DID_ax001', password: 'yU6hJ3kN', enterprise: 'AutoX', svcType: 'NRTK', mode: 'SDK', spec: 'year', stack: 5, device: 'RoboTaxi-Gen5', activated: 'inactive', created: '2026-05-09', expires: '2027-05-09', partner: 'ZNJS', activationTime: '' }
  ],
  partners: [
